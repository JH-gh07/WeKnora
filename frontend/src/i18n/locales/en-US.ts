export default {
  evaluationRun: {
    lookup: {
      ...
      description: 'Enter a stable run_id (UUID) to open that evaluation run\'s unified report.',
      placeholder: 'Enter run_id (UUID)',
      submit: 'View report',
      empty: 'Please enter a run_id',
      invalid: 'Invalid run_id — expected a UUID',
    },
    detail: {
      title: 'Evaluation Run #{id}',
      description: 'Retrieval quality, answer quality, cost and latency for one run_id, plus usage, cache, measurement health and trust status.',
      refresh: 'Refresh',
      loading: 'Loading report…',
      retry: 'Retry',
      runningNote: 'Run in progress, auto-refreshing…',
      refreshStopped: 'Auto-refresh stopped (limit reached). Refresh manually.',
      notFound: 'Evaluation run not found',
      forbidden: 'You do not have permission to view this run',
      loadFailed: 'Failed to load the report',
      notAvailable: '—',
      runMetaTitle: 'Run information',
      runId: 'Run ID',
      ...
      cost: {
        knownSubtotal: 'Known estimated subtotal',
        currency: 'Currency',
        unknownCalls: 'Unknown-price calls',
        mixedCurrency: 'Mixed currency',
        estimate: 'estimate',
      },
      latency: {
        wallClock: 'Evaluation wall-clock',
      ...
      cache: {
        localEmbedding: 'Local embedding cache',
        promptCache: 'Provider Prompt Cache',
        implementationStatus: 'Implementation status',
        logicalItemCount: 'Logical items',
        hitCount: 'Hits',
        missCount: 'Misses',
        ...
        cacheReportedInputTokens: 'Reported input tokens',
      },
      trust: {
        runMeasurementStatus: 'Run measurement status',
        tenantWindowHealth: 'Workspace-window health',
        healthFrom: 'From',
        healthTo: 'To',
        healthStatus: 'Status',
        meteringAttempted: 'Metering attempted',
        meteringPersisted: 'Metering persisted',
        meteringFailed: 'Metering failed',
        healthScopeNote: 'This value is workspace + time-window scoped; it does not prove this run\'s metering completeness.',
      },
      warnings: 'Warnings',
      warningSection: 'Section: {section}',
