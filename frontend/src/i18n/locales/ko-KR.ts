export default {
  evaluationRun: {
    lookup: {
      title: '평가 실행',
      description: '평가의 안정적인 run_id(UUID)를 입력하여 해당 실행의 통합 보고서를 엽니다.',
      placeholder: 'run_id(UUID) 입력',
      submit: '보고서 보기',
      empty: 'run_id를 입력하세요',
      invalid: 'run_id 형식이 잘못되었습니다. UUID여야 합니다',
    },
    detail: {
      title: '평가 실행 #{id}',
      description: '하나의 run_id 아래 검색 품질, 답변 품질, 비용, 지연 시간과 사용량, 캐시, 측정 상태, 신뢰 상태를 함께 표시합니다.',
      refresh: '새로고침',
      loading: '보고서 로드 중…',
      retry: '재시도',
      runningNote: '실행 중, 자동 새로고침 중…',
      refreshStopped: '자동 새로고침이 중지되었습니다(최대 횟수 도달). 수동으로 새로고침하세요.',
      notFound: '평가 실행을 찾을 수 없습니다',
      forbidden: '이 평가 실행을 볼 권한이 없습니다',
      ...
      startedAt: '시작 시간',
      endedAt: '종료 시간',
      persistenceStatus: '저장 상태',
      cleanupStatus: '정리 상태',
      interruptionReason: '중단 사유',
      reasonCode: '사유 코드',
      sections: {
        retrieval: '검색 품질',
        answer: '답변 품질',
      ...
      cost: {
        knownSubtotal: '알려진 추정 소계',
        currency: '통화',
        unknownCalls: '가격 미상 호출 수',
        mixedCurrency: '혼합 통화',
        estimate: '추정',
      },
      latency: {
      ...
      cache: {
        localEmbedding: '로컬 임베딩 캐시',
        promptCache: '제공자 Prompt Cache',
        implementationStatus: '구현 상태',
        logicalItemCount: '논리 항목 수',
        hitCount: '적중',
        missCount: '미스',
        measurementStatus: '측정 상태',
        eligible: 'Eligible',
        reported: 'Reported',
        unsupported: 'Unsupported',
        cacheReadTokens: '캐시 읽기 토큰',
        cacheWriteTokens: '캐시 쓰기 토큰',
        cacheMissTokens: '캐시 미스 토큰',
        cacheReportedInputTokens: '보고된 입력 토큰',
      },
      trust: {
        runMeasurementStatus: '실행 측정 상태',
        tenantWindowHealth: '워크스페이스 시간 창 상태',
        healthFrom: '시작',
        healthTo: '종료',
        healthStatus: '상태',
        meteringAttempted: '측정 시도',
        meteringPersisted: '측정 저장됨',
        meteringFailed: '측정 실패',
        healthScopeNote: '이 값은 워크스페이스 + 시간 창 기준이며, 이 실행의 측정 완전성을 의미하지 않습니다.',
      },
      warnings: '경고',
      warningSection: '구역: {section}',
      noWarnings: '경고 없음',
    },
    status: {
      PENDING: '대기 중',
