export default {
  evaluationRun: {
    lookup: {
      title: '评测运行',
      description: '输入一次评测的稳定 run_id（UUID）查看该次运行的统一报告。',
      placeholder: '输入 run_id（UUID）',
      submit: '查看报告',
      empty: '请输入 run_id',
      invalid: 'run_id 格式无效，应为 UUID',
    },
    detail: {
      title: '评测运行 #{id}',
      description: '同一 run_id 下统一呈现检索质量、答案质量、成本与耗时，并附带用量、缓存、测量健康与可信状态。',
      refresh: '刷新',
      loading: '正在加载报告…',
      retry: '重试',
      runningNote: '运行中，正在自动刷新…',
      refreshStopped: '已停止自动刷新（达到最大次数），请手动刷新。',
      notFound: '未找到该评测运行',
      forbidden: '无权查看该评测运行',
      loadFailed: '加载报告失败',
      notAvailable: '—',
      ...
      cost: {
        knownSubtotal: '已知估算小计',
        currency: '币种',
        unknownCalls: '未知价格调用数',
        mixedCurrency: '混币',
        estimate: '估算',
      },
      latency: {
      ...
      cache: {
        localEmbedding: '本地 Embedding 缓存',
        promptCache: 'Provider Prompt Cache',
        implementationStatus: '实现状态',
        logicalItemCount: '逻辑条目数',
        hitCount: '命中',
        missCount: '未命中',
        measurementStatus: '计量状态',
        eligible: 'Eligible',
        reported: 'Reported',
        ...
        cacheReportedInputTokens: '上报输入 Token',
      },
      trust: {
        runMeasurementStatus: 'Run 计量状态',
        tenantWindowHealth: '工作区时间窗健康',
        healthFrom: '起始',
        healthTo: '结束',
        healthStatus: '状态',
        meteringAttempted: '计量尝试',
        meteringPersisted: '计量已持久化',
        meteringFailed: '计量失败',
        healthScopeNote: '该健康值按工作区 + 时间窗统计，不代表本 Run 的计量完整性。',
      },
      warnings: '告警',
      warningSection: '分区：{section}',
      noWarnings: '无告警',
    },
    status: {
      PENDING: '等待中',
