export default {
  evaluationRun: {
    lookup: {
      title: 'Запуски оценки',
      description: 'Введите стабильный run_id (UUID), чтобы открыть сводный отчёт этого запуска.',
      placeholder: 'Введите run_id (UUID)',
      submit: 'Открыть отчёт',
      empty: 'Введите run_id',
      invalid: 'Неверный формат run_id — ожидается UUID',
    },
    detail: {
      title: 'Запуск оценки #{id}',
      description: 'Качество поиска, качество ответа, стоимость и задержка по одному run_id, а также использование, кэш, состояние измерений и доверие.',
      refresh: 'Обновить',
      loading: 'Загрузка отчёта…',
      retry: 'Повторить',
      runningNote: 'Выполняется, идёт автообновление…',
      refreshStopped: 'Автообновление остановлено (достигнут лимит). Обновите вручную.',
      notFound: 'Запуск оценки не найден',
      forbidden: 'Нет доступа к этому запуску',
      loadFailed: 'Не удалось загрузить отчёт',
      notAvailable: '—',
      runMetaTitle: 'Информация о запуске',
      runId: 'Run ID',
      legacyTaskId: 'Legacy Task ID',
      status: 'Статус',
      ...
      startedAt: 'Начало',
      endedAt: 'Окончание',
      persistenceStatus: 'Статус сохранения',
      cleanupStatus: 'Статус очистки',
      interruptionReason: 'Причина прерывания',
      ...
      cost: {
        knownSubtotal: 'Известный оценочный итог',
        currency: 'Валюта',
        unknownCalls: 'Вызовы с неизвестной ценой',
        mixedCurrency: 'Смешанные валюты',
        estimate: 'оценка',
      },
      latency: {
        wallClock: 'Затраченное время оценки',
      ...
      cache: {
        localEmbedding: 'Локальный кэш эмбеддингов',
        promptCache: 'Prompt Cache провайдера',
        implementationStatus: 'Статус реализации',
        logicalItemCount: 'Логических элементов',
        hitCount: 'Попадания',
        missCount: 'Промахи',
        measurementStatus: 'Статус измерений',
        eligible: 'Eligible',
        reported: 'Reported',
        unsupported: 'Unsupported',
        cacheReadTokens: 'Токены чтения кэша',
        cacheWriteTokens: 'Токены записи кэша',
        cacheMissTokens: 'Токены промаха кэша',
        cacheReportedInputTokens: 'Отчётные входные токены',
      },
      trust: {
        runMeasurementStatus: 'Статус измерений запуска',
        tenantWindowHealth: 'Состояние окна рабочего пространства',
        healthFrom: 'С',
        healthTo: 'По',
        healthStatus: 'Статус',
        meteringAttempted: 'Попыток учёта',
        meteringPersisted: 'Учтено сохранено',
        meteringFailed: 'Ошибок учёта',
        healthScopeNote: 'Это значение относится к окну рабочего пространства, а не к полноте учёта данного запуска.',
      },
      warnings: 'Предупреждения',
      warningSection: 'Раздел: {section}',
