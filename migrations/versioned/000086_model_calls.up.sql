CREATE TABLE IF NOT EXISTS model_calls (
    ...
    reported_model_revision VARCHAR(128),
    deployment_id VARCHAR(128),
    input_tokens INTEGER, output_tokens INTEGER, cache_read_tokens INTEGER,
    cache_write_tokens INTEGER, cache_miss_tokens INTEGER,
    usage_finality VARCHAR(24) NOT NULL DEFAULT 'unavailable',
    cache_status VARCHAR(24) NOT NULL DEFAULT 'unreported',
    provider_latency_ms INTEGER, request_elapsed_ms INTEGER NOT NULL DEFAULT 0,
    success BOOLEAN NOT NULL DEFAULT FALSE,
    error_type VARCHAR(128) NOT NULL DEFAULT '',
    attempt_count INTEGER,
    attempt_observability VARCHAR(24) NOT NULL DEFAULT 'unobservable',
    estimated_cost DECIMAL(20,10), currency VARCHAR(8) NOT NULL DEFAULT '',
    pricing_version VARCHAR(64) NOT NULL DEFAULT '', pricing_source VARCHAR(128) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS model_metering_health (
    ...
    attempted_at TIMESTAMP WITH TIME ZONE NOT NULL, persisted BOOLEAN NOT NULL
);
